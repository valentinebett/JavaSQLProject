...
public class DataImporter {
    ...
    public static void main(String[] args) {
        importPatients("patients.csv");
        importVisits("visits.csv");
        importDiagnoses("diagnoses.csv");
        importTreatment("treatments.csv"); // ✅ fixed to match your plural filename
    }
